  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        cinematic: "bg-gradient-primary text-primary-foreground hover:shadow-glow hover:scale-105 transition-glow border border-primary/20",
        glass: "bg-gradient-glass backdrop-blur-xl border border-white/10 text-foreground hover:border-primary/30 hover:shadow-glass transition-glow",
        accent: "bg-gradient-accent text-accent-foreground hover:shadow-glow hover:scale-105 transition-glow border border-accent/20",
      },
      size: {
